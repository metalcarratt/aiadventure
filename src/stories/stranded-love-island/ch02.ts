...
export const chapter2: Chapter = [
    ...
    },
    {
        ...
        choices: [
            {
                say: 'Are you sure there\'s anything here to find?',
                next: {
                    sequence: [
                        {
                            pic: EMIKO_IMG,
            ...
            {
                say: 'That\'s a good plan. Let\'s split up and search.',
                next: {
                    sequence: [
                        {
                            pic: HIROKO_IMG,
    ...
    },
    {
        ...
        choices: [
            ...
            {
                say: 'I don\'t think this will be enough to sustain us for long.',
                next: {
                    sequence: [
                        {
                            pic: HIROKO_IMG,
